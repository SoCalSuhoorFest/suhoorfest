...
const Footer = () => {
  return <footer className="bg-card/50 border-t border-border/50 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#info" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Event Info
                </a>
              </li>
              <li>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex gap-4 justify-center md:justify-end mb-4">
              <a href="https://www.instagram.com/socalsuhoorfest/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-all duration-300">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-all duration-300">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="mailto:info@socalsuhoorfest.com" className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-all duration-300">
