  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-gold-light via-gold to-gold-dark text-background font-semibold shadow-lg hover:shadow-[0_0_30px_hsl(40,85%,55%,0.4)] hover:scale-105 active:scale-100",
        "hero-outline": "border-2 border-primary bg-transparent text-foreground hover:bg-primary/10 hover:border-primary font-semibold",
        gold: "bg-primary text-primary-foreground hover:bg-gold-light shadow-[0_0_20px_hsl(40,85%,55%,0.3)] hover:shadow-[0_0_30px_hsl(40,85%,55%,0.5)]",
      },
      size: {
